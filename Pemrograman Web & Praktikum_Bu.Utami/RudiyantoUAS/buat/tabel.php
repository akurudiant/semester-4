...
<body>
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<a href='#' class='print' data-nim=" . $row["nim"] . ">Print</a>";
    ...
    <script>
		...
		// Mengarahkan pengguna ke halaman print.php dengan NIM sebagai parameter
        var nim = this.getAttribute("data-nim");
        window.location.href = 'print.php?nim=' + encodeURIComponent(nim);
    });
}
